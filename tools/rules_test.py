...
expect("stranger can't drop a member", room_patch("dave", "p_alice_bob", {"members": arr("alice", "carol")}), False)
expect("carol leaves herself", room_patch("carol", "p_alice_bob", {"members": arr("alice", "bob")}), True)
